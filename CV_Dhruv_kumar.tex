...
Distributed Systems, Parallel Computing, Data Mining, Machine Learning.
...
%\vspace*{.3cm}
\item {\bf Relevant Courses}: Distributed Systems, Advanced Machine Learning, Matrix Theory, Probability and Statistics.
...
{\bf Distributed Computing Systems Group, UMN, Twin Cities}\hfill {\bf Nov 2017 - Present}\\
%\vspace{-.3cm}
{\em {\bf Project:} Geo-distributed Real-Time Data Analytics} \\
{\em {\bf Mentors:} Abhishek Chandra, Jon Weissman}
\vspace{.3cm}
\begin{list2}
	\item Design of algorithms for optimizing Timeliness, Accuracy and Latency in Geo-distributed Real-Time data analytics.
	\item Currently exploring Apache Flink for implementation of these algorithms.
\end{list2}

{\bf Karypis Lab, UMN, Twin Cities}\hfill {\bf Feb 2018 - Present}\\
%\vspace{-.3cm}
{\em {\bf Topic:} Graph Partitioning Algorithms} \\
{\em {\bf Mentor:} George Karypis}
\vspace{.3cm}
\begin{list2}
	\item Design and implementation of a Graph Partitioning Algorithm using Bayesian inferential methods based on the Stochstic Block Models.
	\item Currently, implementing the parallel version of the algorithm using OpenMP and C.
\end{list2}
